                    ...
                    if (_.has(state.funct, name) && !state.funct["(global)"]) {
                        if (state.funct[name] === true) {
                            if (state.option.latedef) {
                                if ((state.option.latedef === true && _.contains([state.funct[name], type], "unction")) || !_.contains([state.funct[name], type], "unction")) {
                            ...
                            if (_.has(implied, name)) {
                                if (state.option.latedef) {
                                    if ((state.option.latedef === true &&
                                        _.contains([state.funct[name], type], "unction")) || !_.contains([state.funct[name], type], "unction")) {
                                        warning("W003", state.tokens.next, name);
                                    }
                                }
                                    ...
                                    if (implied === "for") {
                                        ...
                                        switch (state.funct[ident]) {
                                            ...
                                            case "var":
                                                break;
                                            default:
                                                if (!state.funct["(blockscope)"].getlabel(ident) && !(scope[ident] || {})[ident]) {
